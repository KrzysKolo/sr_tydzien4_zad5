...
const MyButton = React.forwardRef(({onMouseOver, onMouseOut}, ref) => {

    return (
        <div className="App">
           <button className="btn" type="button" ref={ref} onMouseOver={onMouseOver} onMouseOut={onMouseOut}>Click me!</button>
        </div>
    )
})
