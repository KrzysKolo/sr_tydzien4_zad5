...
const MyButton = React.forwardRef(({onMouseMove, onMouseOut}, ref) => {

    return (
        <div className="App">
           <button className="btn" type="button" ref={ref} onMouseMovie={onMouseMove} onMouseOut={onMouseOut}>Click me!</button>
        </div>
    )
})
